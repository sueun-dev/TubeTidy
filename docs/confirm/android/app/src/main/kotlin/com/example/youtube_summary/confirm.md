...
## Scope
- Folder: `android/app/src/main/kotlin/com/example/youtube_summary`
- Checked At: `2026-02-06 21:19:05`
- Tracked Files (recursive): `2`
- Text Lines Scanned: `5`
- TODO/FIXME/XXX/HACK Markers: `0`
- Unreadable Text Files: `0`

## Folder-Level Checks
- [x] Files in scope are tracked by git
- [x] Source naming check: `N/A` (no .dart/.py/.sh in scope)
- Violations: 없음
